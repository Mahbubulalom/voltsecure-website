...
(function(){
  ...
  var DE_MAP = {
    ...
    "CTSP-certified (Certified Technical Security Professional), with nineteen years' hands-on experience in the fire & security industry. Started as a South Wales apprentice in 2006; founded VoltSecure in 2020.": "CTSP-zertifiziert (Certified Technical Security Professional), mit neunzehn Jahren praktischer Erfahrung in der Brandschutz- und Sicherheitsbranche. Begann 2006 als Auszubildender in Südwales; gründete 2020 VoltSecure.",
    "We're an engineer-led company. Founded in 2020 by an apprentice who came up through the trade, scaled to a UK-and-Europe operation in five years, and still doing the work properly - to the standards that matter, with the certifications to back it up.": "Wir sind ein ingenieursgeführtes Unternehmen. Gegründet 2020 von einem Auszubildenden, der das Handwerk von Grund auf gelernt hat, in fünf Jahren zu einem Großbritannien- und Europa-Betrieb skaliert und immer noch die Arbeit richtig macht - nach den Standards, die zählen, mit den Zertifizierungen, die es belegen.",
    "The business started on the back end of the pandemic in 2020. Within its first year it had passed NICEIC, SSAIB and Constructionline audits - the hardest three to get through as a new business - and landed a national electrical contract on the strength of that paperwork. ECA, FSA and JIB memberships followed, along with a BAFE SP203-1 certification covering all four modules of fire detection and alarm work.": "Das Unternehmen entstand am Ende der Pandemie 2020. Innerhalb des ersten Jahres bestand es die NICEIC-, SSAIB- und Constructionline-Audits - die drei härtesten für ein neues Unternehmen - und landete einen landesweiten Elektrovertrag auf der Stärke dieser Unterlagen. ECA-, FSA- und JIB-Mitgliedschaften folgten, ebenso wie eine BAFE SP203-1-Zertifizierung für alle vier Module der Brandmelde- und Alarmarbeiten.",
